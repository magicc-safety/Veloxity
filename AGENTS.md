...
The local ROSflight ROS 2 workspace under `/home/skink/projects/voloxide_setup/workspace` is a
...
goal is to prove that the Voloxide sim firmware endpoint can connect to the existing ROSflight
