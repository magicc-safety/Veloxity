...
Veloxity is completely intercompatible with the [ROSflight sim](https://docs.rosflight.org/latest/user-guide/rosflight-sim/).
...
and follow the instructions on our [Devpod](https://github.com/Derekbenj/rosflight_devpod/tree/TRLarsen/devpod_test_updates), which ensure reproducability.
