...
use crate::sensors::{RosflightPacketHeader, MagPacket};
...
pub static MAG_SIGNAL  : Signal<CriticalSectionRawMutex, MagPacket> = Signal::<CriticalSectionRawMutex, MagPacket>::new();
