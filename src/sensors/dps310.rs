...
impl Dps310Sensor
{
    ...
    fn process_temperature_data(&mut self, raw_t: i32, raw_t_previous: &mut i32, cal: &[f64;9]) -> (f64, f64) {
    ...
    pub async fn run(&mut self)
    {
        ...
        loop
        {
            ...
            let (raw_t_f64, temperature) = self.process_temperature_data(raw_t, &mut raw_t_previous, &mut cal);
