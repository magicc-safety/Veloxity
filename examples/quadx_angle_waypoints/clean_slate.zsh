...
EXAMPLE_PATTERN='roscopter (estimator|path_manager|path_planner)|/roscopter/(estimator|path_manager|path_planner)|trajectory_to_angle_command|rviz_waypoint_publisher|ros2 bag record'
...
stop_matches "quad-X angle waypoint example" "$EXAMPLE_PATTERN"
